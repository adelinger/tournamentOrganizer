...
{
    class tournamentScorerLVAdapter :BaseAdapter<tournamentScorer>
    {
        private List<tournamentScorer> Items;
        private Context myContext;
      

        public tournamentScorerLVAdapter(Context context, List<tournamentScorer> items)
        {
            Items = items;
            myContext = context;         
        }
        ...
        public override tournamentScorer this[int position] => Items[position];
